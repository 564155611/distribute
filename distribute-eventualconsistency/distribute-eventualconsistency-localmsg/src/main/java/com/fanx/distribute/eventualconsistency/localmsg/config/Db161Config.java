package com.fanx.distribute.eventualconsistency.localmsg.config;
...
@Configuration
@MapperScan(basePackages = {"com.fanx.distribute.eventualconsistency.localmsg.mapper.db161"},sqlSessionFactoryRef = "sqlSessionFactoryBean161")
